...
import com.application.gallaoui.application.email.EmailSending;
import com.application.gallaoui.application.enumeration.UserRole;
import com.application.gallaoui.application.model.User;
import com.application.gallaoui.application.service.UserService;
...
public class RegistrationService {
        ...
        private final EmailSending emailSender;
    ...
    public String register(RegistrationRequest req){
        ...
        String link = "http://localhost:8080/connect/register/confirm?token="+token;
        
        emailSender.send(req.getEmail(), buildEmail(req.getName(), link));
